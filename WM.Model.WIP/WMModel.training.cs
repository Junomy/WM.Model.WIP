...
namespace WM_Model_WIP
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Junomy\source\repos\WM.Model.WIP\WM.Model.WIP\data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"type", @"type", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"type",@"id",@"date"}))      
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=4,NumberOfLeaves=4,FeatureFraction=1F,LabelColumnName=@"amount",FeatureColumnName=@"Features"}));
